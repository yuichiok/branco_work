...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TH1F * layer_hit = new TH1F("myhits","nhit",1000,0,300);
   TH1F * myenergy = new TH1F("myenergy","Energy",10000,0,9999);
   TH1F * myenergy1 = new TH1F("myenergy1","Energy",10000,0,9999);
        ...
        for (int ihit=0; ihit < nhit_len; ihit++){
           ...
           if (hit_slab[ihit] ==7){
               if (hit_sca[ihit] <2){
                     ...
                     nhit5++; 
                     total_MIP++;  
                     std::cout << "Hit energy, sca: " << hit_energy[ihit] << ", " << hit_sca[ihit]  << std::endl; 
                  }
            }
