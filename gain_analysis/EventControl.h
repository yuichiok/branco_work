...
// Tue Jun 28 14:10:44 2022 by ROOT version 6.18/00
// from TTree ecal/Build ecal events
// found on file: /home/calice/TB2022-06/SiWECAL-TB-monitoring/data/eudaq_run_090121/full_run.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           hit_slab[2157];   //[nhit_len]
   Int_t           hit_chip[2157];   //[nhit_len]
   Int_t           hit_chan[2157];   //[nhit_len]
   Int_t           hit_sca[2157];   //[nhit_len]
   Float_t         hit_x[2157];   //[nhit_len]
   Float_t         hit_y[2157];   //[nhit_len]
   Float_t         hit_z[2157];   //[nhit_len]
   Int_t           hit_adc_high[2157];   //[nhit_len]
   Int_t           hit_adc_low[2157];   //[nhit_len]
   Float_t         hit_energy[2157];   //[nhit_len]
   Float_t         hit_energy_lg[2157];   //[nhit_len]
   Int_t           hit_n_scas_filled[2157];   //[nhit_len]
   Int_t           hit_isHit[2157];   //[nhit_len]
   Int_t           hit_isMasked[2157];   //[nhit_len]
   Int_t           hit_isCommissioned[2157];   //[nhit_len]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("full_run.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("full_run.root");
      }
